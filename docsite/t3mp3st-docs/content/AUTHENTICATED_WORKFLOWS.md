...
description: "Current authenticated-request support and the design boundary for future interactive workflows."
audience: ["operator", "developer", "security-reviewer"]
category: "operator"
status: "current"
source: "T3MP3ST repository"
sourcePath: "docs/AUTHENTICATED_WORKFLOWS.md"
updated: "2026-07-20"
---
...
For an application you are authorized to test, T3MP3ST can attach operator-supplied headers to requests for one exact origin. See [Target Header Injection](#target-headers). This supports an existing authorized session; it does not acquire a new identity, navigate forms, read a mailbox, or verify a newly created account.
